...
<body>
	<form id="form1" action="<%=basePath %>basic/sys/role_setRoleUser.action" method="post">
		<div class="title">角色【${role.role_name}】的用户维护
		...
		<div class="editorTab">
			<select name="role.user_ids" class="multiselect" multiple="multiple" style="width:679px;">
				<s:iterator value="%{uList}">
					<option value="${user_id}" <s:if test="%{ischoose}">selected="selected"</s:if>>${user_name}(${org_path})</option>
				</s:iterator>
			</select>
		</div>
	</form>
